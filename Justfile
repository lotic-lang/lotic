...
build-test-programs:
    ...
    @./target/release/lotic-cli build -- --manifest-path tests/constraint-executable/Cargo.toml
    @./target/release/lotic-cli build -- --manifest-path tests/constraint-owner/Cargo.toml
    ...
    @./target/release/lotic-cli build -- --manifest-path tests/processor-init/Cargo.toml
...
test:
    ...
    @cargo test --manifest-path tests/constraint-executable/Cargo.toml --all-features
    @cargo test --manifest-path tests/constraint-owner/Cargo.toml --all-features
    ...
    @cargo test --manifest-path tests/processor-init/Cargo.toml --all-features
